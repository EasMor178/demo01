    ...
    >
      ...
      >
        <span
          :style="{
            'text-align': 'center',
            'line-height': `${modules[2].h}px`,
          }"
          >{{ modules[2].moduleName }}</span
        >
      </VueDraggableResizable>
      <VueDraggableResizable
      ...
      >
        <span
          :style="{
            'text-align': 'center',
            'line-height': `${modules[3].h}px`,
          }"
          >{{ modules[3].moduleName }}</span
        >
      </VueDraggableResizable>
      <VueDraggableResizable
      ...
      >
        <span
          :style="{
            'text-align': 'center',
            'line-height': `${modules[4].h}px`,
          }"
          >{{ modules[4].moduleName }}</span
        >
      </VueDraggableResizable>
    </div>
  </div>
